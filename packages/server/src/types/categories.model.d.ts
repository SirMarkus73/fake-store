...
export type GetByIdResult = PromiseResult<Category[],DatabaseError | NotFoundError>
export type PostResult = PromiseResult<Category[], DatabaseError>
export type PatchResult = PromiseResult<Category[],DatabaseError | ParameterError>
