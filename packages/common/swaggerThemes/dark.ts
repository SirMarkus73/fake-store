export const darkTheme = `@media only screen and (prefers-color-scheme: dark) {
  :root {
    color-scheme: dark;
  }
  ...
  .swagger-ui .loading-container .loading::before {
    animation: 1s linear 0s infinite normal none running rotation, .5s ease 0s 1
      normal none running opacity;
